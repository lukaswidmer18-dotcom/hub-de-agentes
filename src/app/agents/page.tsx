...
const mockAgents: Agent[] = [
  {
    ...
    description: 'Ajuda com revisão de código, debugging e sugestões de otimização',
  ...
  },
  {
    ...
    description: 'Processa e analisa datasets, gera insights e visualizações',
    category: 'Dados',
  ...
  },
  {
    ...
    description: 'Responde dúvidas técnicas e guia troubleshooting',
    category: 'Suporte',
